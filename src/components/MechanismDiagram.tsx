...
export function MechanismDiagram() {
  return (
    ...
    >
      ...
      />
      {/* arrow */}
      <path d="M216 48 h30 m0 0 l-6 -4 m6 4 l-6 4" fill="none" stroke="rgba(17,17,17,0.45)" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
      {/* brain icon */}
      <g transform="translate(258 26)" fill="none" stroke="#111111" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
